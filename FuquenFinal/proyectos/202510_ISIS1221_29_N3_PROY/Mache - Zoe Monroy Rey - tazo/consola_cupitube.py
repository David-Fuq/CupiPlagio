...
def ejecutar_buscar_cupitubers_por_pais_categoria_monetizacion(cupitube: dict) -> None:
    ...
    monetizacion= input("Ingresa la monetizacion")
...
def ejecutar_buscar_cupituber_mas_antiguo(cupitube: dict) -> None:
    ...
    print("El CupiTuber más antiguo es",resultado["cupituber"], "y empezó en", resultado["started"])
...
def ejecutar_obtener_visitas_por_categoria(cupitube: dict) -> None:
    ...
    categoria= input("inserta la categoria: ")
    resultado = ct.obtener_visitas_por_categoria(cupitube, categoria)
    print("El total de visitas para la categoría", categoria, "es:", resultado
          )
...
def ejecutar_obtener_categoria_con_mas_visitas(cupitube: dict) -> None:
    ...
    categoria = input("Ingrese la categoría para calcular las visitas totales: ")
    total_visitas = ct.obtener_visitas_por_categoria(cupitube, categoria)
    print("La categoría con más visitas es", categoria, "con", total_visitas, "visitas")
...
def ejecutar_recomendar_cupituber(cupitube: dict) -> None:
    ...
    suscriptores_min = int(input("Ingrese el minimo de suscriptores: "))
    suscriptores_max = int(input("Ingrese el maximo de suscriptores: "))
    fecha_minima = input("Ingrese el límite minimo del rango de fechas: ")
    fecha_maxima = input("Ingrese el límite maximo del rango de fechas: ")

...
def ejecutar_buscar_por_categoria_y_rango_suscriptores(cupitube: dict) -> None:
    ...
    """
    categoria = input("Ingrese la categoría: ").title()
...
def ejecutar_buscar_cupitubers_por_pais_categoria_monetizacion(cupitube: dict) -> None:
    ...
    categoria_buscada= input("Ingrese la categoría: ").capitalize()
    monetizacion_buscada= input("Ingrese la monetización: ").capitalize()
    
    retorno= ct.buscar_cupitubers_por_pais_categoria_monetizacion(cupitube, pais_buscado, categoria_buscada, monetizacion_buscada)

    if retorno != []:
        print("Los CupiTubers de " + pais_buscado + " que pertenecen a la categoría " + categoria_buscada +" y tienen monetización " + categoria_buscada+ " son:"+ str(retorno))
    else:
        print("No se encontraron CupiTubers que cumplan con los criterios.")
...
def ejecutar_buscar_cupituber_mas_antiguo(cupitube: dict) -> None:
    ...
    retorno= ct.buscar_cupituber_mas_antiguo(cupitube)
    
    print(" El CupiTuber más antiguo es " + retorno[ "cupituber"] + " y empezó en " + str(retorno["started"]) + ".")
...
def ejecutar_obtener_visitas_por_categoria(cupitube: dict) -> None:
    ...
    retorno= ct.obtener_visitas_por_categoria(cupitube, categoria_buscada)
    
    print("El total de visitas para la categoría " + categoria_buscada+ " es:" + str(retorno))
...
def ejecutar_obtener_categoria_con_mas_visitas(cupitube: dict) -> None:
    ...
    retorno= ct.obtener_categoria_con_mas_visitas(cupitube)
    print("La categoría con más visitas es " + retorno["categoria"]+ " con "+ str(retorno["visitas"]) + " visitas." )
...
def ejecutar_recomendar_cupituber(cupitube: dict) -> None:
    ...
    suscriptores_min= int(input("Ingrese el número de suscriptores minimo: "))
    suscriptores_max= int(input("Ingrese el número de suscriptores maximo: "))
    fecha_minima=(input("Ingrese la fecha mínima: "))
    fecha_maxima=(input("Ingrese la fecha máxima: "))
    videos_minimos= int(input("Ingrese el numero de videos mínimos: "))
    palabra_clave= input("Intgrese la palabra clave de la descripción: ")
    
    
    retorno= ct.recomendar_cupituber(cupitube, suscriptores_min, suscriptores_max, fecha_minima, fecha_maxima, videos_minimos, palabra_clave)

...
def ejecutar_buscar_cupitubers_por_pais_categoria_monetizacion(cupitube: dict) -> None:
    ...
    monetizacion_buscada = input("Ingrese el tipo de monetización: ")
    ...
    if cupitubers != []:
        print("\nLos CupiTubers de "+ pais_buscado +" que pertenecen a la categoría "+ categoria_buscada +" y tienen monetización "+ monetizacion_buscada +" son:")
        mostrar_cupitubers(cupitubers)
...
def ejecutar_buscar_cupituber_mas_antiguo(cupitube: dict) -> None:
    ...
    if cupituber != []:
        print("\nEl CupiTuber más antiguo es "+ nombre +" y empezó en "+ fecha +".")
...
def ejecutar_obtener_visitas_por_categoria(cupitube: dict) -> None:
    ...
    vistas = ct.obtener_visitas_por_categoria(cupitube, categoria)
    
    if vistas != 0:
        print("\nEl total de visitas para la categoría "+ categoria +" y empezó en "+ str(vistas) +".")
...
def ejecutar_obtener_categoria_con_mas_visitas(cupitube: dict) -> None:
    ...
    categoria_mas_vistas = ct.obtener_categoria_con_mas_visitas(cupitube)
    
    categoria = categoria_mas_vistas["categoria"]
    vistas = categoria_mas_vistas["visitas"]
    
    if categoria_mas_vistas != 0:
        print("\nLa categoría con más visitas es "+ categoria +" con "+ str(vistas) +" visitas.")

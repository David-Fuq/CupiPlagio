...
def ejecutar_buscar_cupitubers_por_pais_categoria_monetizacion(cupitube: dict) -> None:
    ...
    pais_buscado = input("Ingrese el país: ")
    categoria_buscada = input("Ingrese la categoría: ")
    monetizacion_buscada = input("Ingrese el metodo de monetización: ")
...
def ejecutar_buscar_cupituber_mas_antiguo(cupitube: dict) -> None:
    ...
    nombre = cupituber_antiguo["name"]
    fecha = cupituber_antiguo["started"]
    
    print("El cupituber más antiguo es " + nombre + " y empezo en " + fecha + ".")
...
def ejecutar_obtener_visitas_por_categoria(cupitube: dict) -> None:
    ...
    visitas = ct.obtener_visitas_por_categoria(cupitube, categoria_buscada)
   
    print("El total de visitas para la categoría " + categoria_buscada + " es: " + str(visitas) + ".")
...
def ejecutar_obtener_categoria_con_mas_visitas(cupitube: dict) -> None:
    ...
    rta = ct.obtener_categoria_con_mas_visitas(cupitube)
    
    categoria = rta["categoria"]
    visitas = rta["visitas"]
...
def ejecutar_recomendar_cupituber(cupitube: dict) -> None:
    ...
    palabra_clave = input("Ingrese la palabra clave para buscar en la descripción: ")

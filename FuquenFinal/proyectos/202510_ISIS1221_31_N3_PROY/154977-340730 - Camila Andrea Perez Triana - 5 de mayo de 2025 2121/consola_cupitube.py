...
def ejecutar_buscar_cupitubers_por_pais_categoria_monetizacion(cupitube: dict) -> None:
    ...
    pais_buscado = input("Ingrese el país: ").lower()
    categoria_buscada = input("Ingrese la categoría: ").lower()
    monetizacion_buscada = input("Ingrese la monetización: ").lower()
    
    cupitubers = ct.buscar_cupitubers_por_pais_categoria_monetizacion(cupitube, pais_buscado, categoria_buscada, monetizacion_buscada)
    
    if cupitubers != []:
        print ("Los CupiTubers de " + pais_buscado + "que pertenecen a la categoría " + categoria_buscada + " y tienen monetización " + monetizacion_buscada + " son:")
        mostrar_cupituber(cupitubers)
    else:
        print("No se encontraron CupiTubers que cumplan con los criterios.")
...
def ejecutar_buscar_cupituber_mas_antiguo(cupitube: dict) -> None:
    ...
    dicti_antiguo = ct.buscar_cupituber_mas_antiguo(cupitube)
    print ("\n")
    print("#" * 50)
    print ("\n")
    print("El CupiTuber más antiguo es " + dicti_antiguo["cupituber"] + " y empezó en " + dicti_antiguo["started"] + ".")
    print ("\n")
    print("#" * 50)
    print ("\n")
...
def ejecutar_obtener_visitas_por_categoria(cupitube: dict) -> None:
    ...
    cupitubers = str(ct.obtener_visitas_por_categoria(cupitube, categoria_buscada))
    
    print ("\n")
    print("#" * 50)
    print ("\n")
    print("El total de visitas para la categoría " + categoria_buscada.capitalize() + " es: " + cupitubers + ".")
    print ("\n")
    print("#" * 50)
    print ("\n")
...
def ejecutar_obtener_categoria_con_mas_visitas(cupitube: dict) -> None:
    ...
    cupitubers = ct.obtener_categoria_con_mas_visitas(cupitube)
    
    print ("\n")
    print("#" * 50)
    print ("\n")
    print("La categoría con más visitas es " + cupitubers["categoria"].capitalize() + " con " + str(cupitubers["visitas"]) + " visitas.")
    print ("\n")
    print("#" * 50)
    print ("\n")
...
def ejecutar_recomendar_cupituber(cupitube: dict) -> None:
    ...
    suscriptores_min = int(input("Ingrese la cantidad mínima de suscripores: "))
    suscriptores_max = int(input("Ingrese la cantidad máxima de suscripores: "))
    fecha_minima = input ("Ingrese la fecha mínima en un formato de año-mes-día: ")
    fecha_maxima = input ("Ingrese la fecha máxima en un formato de año-mes-día: ")
    videos_minimos = int(input ("Ingrese la cantidad mínima de videos publicados: "))
    palabra_clave = input("Ingrese la palabra clave en la descripción del canal del cupituber: ")
...
def ejecutar_paises_por_categoria(cupitube: dict) -> None:
    ...
    if categoria != "" and categoria in estructura:
        ...
        if paises != {} and paises is not None:
            print("\nLos países con CupiTubers en la categoría " + categoria.capitalize() + " son:")
